...
echo "${GREEN_COLOR}Instaling zshrc...${NO_COLOR}"
cp dots/zsh/zshrc ~/.zshrc
source ~/.zshrc

echo "${GREEN_COLOR}Installing wallpaper...${NO_COLOR}"
cp dots/wallpaper.jpg ${WALLPAPER_DIR}/.wallpaper.jpg

echo "${GREEN_COLOR}Installing I3WM dotfiles...${NO_COLOR}"
mkdir -p ${I3_CONFIG_DIR}
cp -r dots/i3/* ${I3_CONFIG_DIR}

echo "${GREEN_COLOR}Installing Polybar dotfiles...${NO_COLOR}"
mkdir -p ${POLYBAR_CONFIG_DIR}
cp -r dots/polybar/* ${POLYBAR_CONFIG_DIR}

echo "${GREEN_COLOR}Installing Fonts...${NO_COLOR}"
mkdir -p ${FONTS_DIRECTORY}
cp -r dots/fonts/* ${FONTS_DIRECTORY}
fc-cache -fv

echo "${GREEN_COLOR}Installing NeoVim configuration...${NO_COLOR}"
